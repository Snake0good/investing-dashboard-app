import { FaAmazon, FaApple, FaBriefcase, FaCar, FaDollarSign, FaIntercom, FaInvision, FaMoneyBillWave, FaNewspaper, FaShopify } from "react-icons/fa"
...
function Dashboard() {
    ...
    // I need to optimize this with useContext(), but for now these are just the defaults
    const title = location.state.title || 'Dashboard'
    const stocks = location.state.stocks || 123.45
    const ETF = location.state.ETF || 543.21
    const bonds = location.state.bonds || 123.45
    const crypto = location.state.crypto || 543.21
    // const total = location.state.total || total
    const userName = location.state.userName || 'User Name'
    
    const total = +(stocks + ETF + crypto + bonds)
            ...
            <div className="p-5 w-full bg-sky-200 pl-44 min-h-screen">
                ...
                <div className=" mt-2 pl-6">
                    ...
                    <div className="w-full flex">
                        ...
                        <div className=" w-full mr-5 bg-white h-80 mt-3 mb-3 rounded-xl p-3 rounded-xl shadow-xl overflow-y-auto no-scrollbar">
                            ...
                            <div className="border border-gray-200 relative w-full h-[70px] shadow-xl rounded-xl flex justify-between p-2 mt-2 mb-2">
                                <div className="flex space-x-2">
                                    <div className="flex p-3 bg-green-500 h-fit rounded-full">
                                        <FaIntercom className="text-white text-2xl" />
                                    </div>
                                    <div className="">
                                            <h1 className="font-bold">Intercom Inc.</h1>
                                            <p className="text-gray-500">INTE</p>
                                    </div>
                                </div>
                                <div>
                                    <h1 className="font-bold">$29.21</h1>
                                    <h1 className="text-red-500 font-bold">-4.52%</h1>
                                </div>    
                            </div>
                            <div className="border border-gray-200 relative w-full h-[70px] shadow-xl rounded-xl flex justify-between p-2 mt-2 mb-2">
                                <div className="flex space-x-2">
                                    <div className="flex p-3 bg-slate-500 h-fit rounded-full">
                            ...
                            <div className="border border-gray-200 relative w-full h-[70px] shadow-xl rounded-xl flex justify-between p-2 mt-2 mb-2">
                                <div className="flex space-x-2">
                                    <div className="flex p-3 bg-blue-500 h-fit rounded-full">
                                        <FaInvision className="text-white text-2xl" />
                                    </div>
                                    <div className="">
                                            <h1 className="font-bold">Nvidia</h1>
                                            <p className="text-gray-500">NVDA</p>
                                    </div>
                                </div>
                                <div>
                                    <h1 className="font-bold">$187.22</h1>
                                    <h1 className="text-green-500 font-bold">+2.33%</h1>
                                </div>    
                            </div>
                        </div>
                        ...
                        <div className=" w-full mr-5 bg-white h-80 mt-3 mb-3 rounded-xl p-3 rounded-xl shadow-xl">
                            <CardBarChart />
                        </div>
                    </div>
                </div>
